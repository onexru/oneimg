<template>
  <div class="app-shell min-h-screen bg-slate-100 text-slate-900 dark:bg-slate-950 dark:text-slate-100 lg:pl-[var(--app-sidebar-width)]">
    ...
    <main class="min-h-[calc(100vh-53px)] px-2.5 pb-3 pt-[calc(var(--app-header-height-mobile)+8px)] sm:px-4 sm:pb-0 md:px-5 md:pb-0 md:pt-[calc(var(--app-header-height)+10px)] xl:px-6 2xl:px-8">
      <div class="mx-auto">
        <router-view />
      </div>
    </main>
